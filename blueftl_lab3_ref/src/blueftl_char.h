...
#define BLUEFTL_CHAR_IOCTL_TIMEOUT		_IOR(BLUEFTL_CHAR_MAJOR_NUM,  2, long)	/* the period during which we wait for responses from the user-level FTL */ #define BLUEFTL_CHAR_IOCTL_SEND_DATA	_IOR(BLUEFTL_CHAR_MAJOR_NUM,  3, char*)	
